...
// kopium command: kopium ciliumnodes.cilium.io -A
...
pub struct CiliumNodeIpam {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "pod-cidr-allocation-threshold")]
    pub pod_cidr_allocation_threshold: Option<i64>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "pod-cidr-release-threshold")]
    pub pod_cidr_release_threshold: Option<i64>,
